...
public class GLText {
    ...
    void initDraw(float red, float green, float blue, float alpha) {
        ...
        //EFISRenderer.checkGlError("gltext"); //b2
        ...
        //b2 not needed// GLES20.glEnableVertexAttribArray(mColorHandle);
        //b2 not needed// EFISRenderer.checkGlError("gltext"); //b2
    ...
    public void end() {
        ...
        //b2 not needed// GLES20.glDisableVertexAttribArray(mColorHandle);
        //b2 not needed// EFISRenderer.checkGlError("gltext"); //b2
    }
